...
namespace Bubblevel_MatchService.Controllers
{
    public class CustomerController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Email,HasActiveSupportPlan,DateCreated")] Customer customer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Email,HasActiveSupportPlan,DateCreated")] Customer customer)
        {
            if (id != customer.Id)
            {
                return NotFound();
